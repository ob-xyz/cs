...
export default function Index() {
  ...
  return (
    <div className="container">
      ...
      <div className="text">
      <p>Stop the Psyop.</p>
      <p>Canada has the greatest citizens in the world, but under Liberal leadership, you'd never know it. That's why me and you are gonna stop the psyop, and clean up the slop.</p>
