...
export default function Index() {
  ...
  return (
    <div className="container">
      ...
      <div className="text">
      <p>Stop the Psyop.</p>
      <p>Canada has the most successful citizens in the world, but under Liberal leadership, you'd never know it. And, that's why me and you are gonna stop the psyop, and clean up the slop.</p>
